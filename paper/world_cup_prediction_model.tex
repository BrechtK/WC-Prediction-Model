...
In historical validation the market-consistent matrix \emph{including} Asian-handicap
...
Generative AI tools, including ChatGPT, Claude and Codex, were used as assistants during the development of this project. Their use included code drafting, debugging support, documentation review, and editorial suggestions for this manuscript. All modelling choices, empirical checks, interpretation of results, and final text are the responsibility of the author.
